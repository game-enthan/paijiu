...
% gm_take_poker(Num) ->
%     Mahjonglist = get(?MAHJONG_LIST),
%     gm_take_poker_(Num, Mahjonglist, []).
% gm_take_poker_(Num, Mahjonglist, List4) when Num =< 0 ->
%     put(?MAHJONG_LIST, Mahjonglist),
%     List4;
% gm_take_poker_(_, Mahjonglist = [], List4) ->
%     put(?MAHJONG_LIST, Mahjonglist),
%     List4;
% gm_take_poker_(Num, [H|List5], List4) ->
%     Num2 = H#mahjong.num,
%     case lists:keyfind(9-Num2, #mahjong.num, List5) of
%         false ->
%             gm_take_poker_(Num - 1, List5, [H|List4]);
%         H2 ->
%             put(?MAHJONG_LIST, lists:keydelete(9-Num2, #mahjong.num, List5)),
%             B = [H] ++ [H2] ++ List4,
%             B
%     end.
...
zhuangjiawin(Style, Dianshu, NineDouble, XianDouble, ZhuangDouble, Type, Zhuanglose, Zhuangjia = #player_tuiduizi{score_change = ZhuangScore},
    ...
    %                     Type, 
    %                     Zhuanglose, 
    %                     Zhuangjia#player_tuiduizi{score_change = ZhuangScore + 3 * chose_type(Type, Player)}, 
    %                     Playerlist,
    ...
    %         end;
    %     ?SANPAI ->
    %         case Dianshu >= 9 andalso 3 =:= 3 of  %% todo
    %             true ->
    %                 zhuangjiawin(
    %                     Style, 
    %                     Dianshu, 
...
% calc_score(Mahjonglist, PairsDouble, Isonered, Isriver)->
%     MahjongZhuang = lists:keyfind(4, #mahjonglist.mahjong_type, Mahjonglist),
%     calc_score(MahjongZhuang, Mahjonglist -- [MahjongZhuang], PairsDouble, Isonered, Isriver, []).

% calc_score(_MahjongZhuang, [], _PairsDouble, _Isonered, _Isriver, Zhuanglose)->
%     Playerlist = get(?DICT_PLAYER_LIST),
%     Zhuangjiaid = get(?DICT_ZHUANGJIAID),
%     Zhuangjia = lists:keyfind(Zhuangjiaid, #player_tuiduizi.id, Playerlist),
%     Xianlist = Playerlist -- [Zhuangjia],
...
% calc_score(MahjongZhuang, [Mahjongxian | Mahjonglist], PairsDouble, Isonered, Isriver, Zhuanglose)->
%     if
%         MahjongZhuang#mahjonglist.mahjong_style > Mahjongxian#mahjonglist.mahjong_style ->
%             zhuangjiawin(
%                 MahjongZhuang#mahjonglist.mahjong_style, 
...
%                 Mahjongxian#mahjonglist.mahjong_type, 
%                 Zhuanglose),
%             calc_score(MahjongZhuang, Mahjonglist, PairsDouble, Isonered, Isriver, Zhuanglose);
%         MahjongZhuang#mahjonglist.mahjong_style < Mahjongxian#mahjonglist.mahjong_style ->
%             xianjiawin(Mahjongxian#mahjonglist.mahjong_style, Mahjongxian#mahjonglist.mahjong_dianshu, PairsDouble,
%             Mahjongxian#mahjonglist.mahjong_type, Isonered, Isriver, [Mahjongxian#mahjonglist.mahjong_type | Zhuanglose]),
%             %%      ?DEBUG("闲家赢"),
%             calc_score(MahjongZhuang, Mahjonglist, PairsDouble, Isonered, Isriver, [Mahjongxian#mahjonglist.mahjong_type | Zhuanglose]);
%         true ->
%             case MahjongZhuang#mahjonglist.mahjong_style of
%                 ?DUIZI ->
%                     Zhuangmahjonglist = MahjongZhuang#mahjonglist.mahjong_list,
...
% %%庄家赢
% zhuangjiawin(Style, Dianshu, PairsDouble, Type, Zhuanglose) ->
%     Playerlist = get(?DICT_PLAYER_LIST),
%     Zhuangjiaid = get(?DICT_ZHUANGJIAID),
%     Zhuangjia = lists:keyfind(Zhuangjiaid, #player_tuiduizi.id, Playerlist),
%     Playerlist1 = Playerlist -- [Zhuangjia],
%     zhuangjiawin(Style, Dianshu, PairsDouble, Type, Zhuanglose, Zhuangjia, Playerlist1, []).

% zhuangjiawin(_Style, _Dianshu, _PairsDouble, _Type, _Zhuanglose, Zhuangjia, [], Scorelist) ->
%     Playerlist = [Zhuangjia | Scorelist],
%     %%  ?DEBUG("玩家列表3：~w",[Playerlist]),
%     put(?DICT_PLAYER_LIST, Playerlist);
% zhuangjiawin(Style, Dianshu, PairsDouble, Type, Zhuanglose, Zhuangjia, [Player = #player_tuiduizi{is_playing = false} | Playerlist], Scorelist) ->
%     zhuangjiawin(Style, Dianshu, PairsDouble, Type, Zhuanglose, Zhuangjia, Playerlist, [Player | Scorelist]);

% zhuangjiawin(Style, Dianshu, PairsDouble, Type, Zhuanglose, Zhuangjia = #player_tuiduizi{score_change = ZhuangScore},
%     [Player = #player_tuiduizi{score_change = XianScore}|Playerlist], Scorelist) ->
%     %%  ?DEBUG("1111111111"),
%     case Style of
%         ?DUIZI ->
%             case PairsDouble of %%判断加倍的类型
%                 3 ->
%                     zhuangjiawin(
%                         Style, 
%                         Dianshu, 
...
%             end;
%         ?SANPAI ->
%             case Dianshu >= 9 andalso PairsDouble =:= 3 of
%                 true ->
%                     zhuangjiawin(
%                         Style, 
%                         Dianshu, 
...
% xianjiawin(Style, Dianshu, PairsDouble, Type, Isonered, Isriver, Zhuanglose) ->
%     Playerlist = get(?DICT_PLAYER_LIST),
%     Zhuangjiaid = get(?DICT_ZHUANGJIAID),
%     Zhuangjia = lists:keyfind(Zhuangjiaid, #player_tuiduizi.id, Playerlist),
%     Playerlist1 = Playerlist -- [Zhuangjia],
%     xianjiawin(Style, Dianshu, PairsDouble, Type, Isonered, Isriver, Zhuanglose, Zhuangjia, Playerlist1, []).

% xianjiawin(_Style, _Dianshu, _PairsDouble, _Type, _Isonered, _Isriver, _Zhuanglose, Zhuangjia, [], Scorelist) ->
%     Playerlist = [Zhuangjia | Scorelist],
%     %%  ?DEBUG("玩家列表4：~w",[Playerlist]),
%     put(?DICT_PLAYER_LIST, Playerlist);
% xianjiawin(Style, Dianshu, PairsDouble, Type, Isonered, Isriver, Zhuanglose, Zhuangjia, [Player = #player_tuiduizi{is_playing = false} |
%     Playerlist], Scorelist) ->
%     xianjiawin(Style, Dianshu, PairsDouble, Type, Isonered, Isriver, Zhuanglose, Zhuangjia, Playerlist, [Player | Scorelist]);

% xianjiawin(Style, Dianshu, PairsDouble, Type, Isonered, Isriver, Zhuanglose, Zhuangjia = #player_tuiduizi{score_change =
%     Zhuangscore}, [Player = #player_tuiduizi{score_change = Xianscore} | Playerlist1], Scorelist) ->
%     %%  ?DEBUG("222222"),
%     case Style of
%         ?DUIZI ->
%             case PairsDouble of             %%判断对子是否翻倍（1不翻倍，2闲家翻倍，3庄闲家翻倍）
%                 2 ->
%                     xianjiawin(
%                         Style,
%                         Dianshu,
